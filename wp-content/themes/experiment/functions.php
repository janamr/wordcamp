...
function experiment_content_width() {
	...
	$GLOBALS['content_width'] = apply_filters( 'experiment_content_width', 640 );
}
...
function experiment_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'experiment' ),
		'id'            => 'sidebar-1',
...
function experiment_scripts() {
	...
	wp_enqueue_style('experiment-fonts', 'https://fonts.googleapis.com/css?family=PT+Serif:400,400i,700,700i|Source+Sans+Pro:400,400i,600');
